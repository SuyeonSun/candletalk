...
const NweetFactory = ({userObj}) => {
    ...
    return (
        ...
        <div className="factoryInput__container">
            ...
            <input className="factoryInput__arrow" type="submit" value="&rarr;" className="factoryInput__arrow"></input>
        </div>
          ...
          opacity: 0,
            ...
            {attachment && (
                <div className="factoryForm__attachment">
                    <img src={attachment} width="50px" height="50px" style={{backgroundImage: attachment,}}></img>
